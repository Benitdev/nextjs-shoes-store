    ...
    return (
        ...
        >
            <div className="flex justify-between border-b-[1px] border-slate-900/70 px-6 py-2">
                <h3 className=" font-sans text-sm capitalize text-pink-500">
                    mã đơn hàng:{' '}
                ...
                <div className="col-span-2">
                    ...
                    >
                        {order.orderItems.map((item: any, index: number) => (
                            <Link href={`/cart`} key={index}>
                                <div className="flex cursor-pointer items-center gap-2 hover:bg-slate-100/10">
                    ...
                    {order.orderItems.length > 1 && (
                        <button
                            className="mx-auto mt-2 block rounded-md bg-sky-600 px-4 py-1 text-xs text-slate-200 hover:text-slate-900"
            ...
            {order.orderState == 4 && (
                <span className="absolute bottom-2 right-2 rounded-xl bg-red-500 px-3 py-1 text-xs text-slate-900">
                    {' '}
                    Ngày huỷ:{' '}
