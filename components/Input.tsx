...
const Input: React.FC<Props> = ({ register, label, name, type }) => {
    return (
        <div className="relative">
            <input
                {...register}
                className={`peer w-full border-b-2 border-b-gray-400 bg-transparent p-1 text-sm placeholder-transparent focus:border-4 focus:border-b-slate-900 focus:outline-none`}
